...
extern void am_app_utils_buzzer_init(void);
extern bool am_app_utils_buzzer_start(void);
extern void am_app_utils_buzzer_process(void);
extern void am_app_utils_led_buzzer_power_up(void);
extern void am_app_utils_buzzer_power_down(void);
extern void am_app_utils_buzzer_interrupt_routine(void);
//extern void am_app_utils_buzzer_init_power_down(void);

#endif // AM_APP_UTILS_BUZZER_H
